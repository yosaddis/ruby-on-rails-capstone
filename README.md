...
```bash
git clone https://github.com/yosaddis/ruby-on-rails-capstone
```
...
- LinkedIn: [yoseph-addisu-abate](https://www.linkedin.com/in/yoseph-addisu-abate/)
...
- React Native redesign the UI/UX
...
Special thanks to https://www.behance.net/gregoirevella for the design idea.
